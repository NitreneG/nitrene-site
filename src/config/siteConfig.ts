...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "Soft notes, quiet research, images, and fragments",

	// 站点 URL
	site_url: "https://nitrene.fun",

	// 站点描述
	description:
		"NitreneGlog is a personal archive for blog notes, longer articles, projects, photography, literature, research sparks, and server logs.",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/favicon.jpeg",
			alt: "🍀",
		},
		// 导航栏标题
		title: "NitreneGlog",
