...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			// "assets/images/DesktopWallpaper/d1.jpeg",
			// "assets/images/DesktopWallpaper/d2.jpeg",
			"assets/images/DesktopWallpaper/d3.jpg",
			// "assets/images/DesktopWallpaper/d4.jpeg",
			// "assets/images/DesktopWallpaper/d5.jpeg",
			// "assets/images/DesktopWallpaper/d6.jpeg",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/m1-optimized.jpg",
			"assets/images/MobileWallpaper/m2-optimized.jpg",
			"assets/images/MobileWallpaper/m3-optimized.jpg",
	...
	common: {
		...
		homeText: {
			...
			// 主页横幅副标题
			subtitle: [
				"Welcome to Haruki's Spackle Garden!",
				"Condensed Matter Physics is True Physics!",
				"Lily, Haewon, Sullyoon, Bae, Jiwoo, Kyujin and NSWER",
				"NitreneG, Haruki Natsume, ZHJ, are all myself~",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
